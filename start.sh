...
# 设置钱包地址变量
WORKER_WALLET_ADDRESS="3KFhTTnAqHqNh21eaoVwSpEP2EGtLQrZx5rgakb8RjAp"
...
COMMAND_BASE="./ore-mine-pool-linux worker --alias TENSORFLOW --worker-wallet-address ${WORKER_WALLET_ADDRESS} >> worker.log 2>&1"
